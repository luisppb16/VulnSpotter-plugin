...
public class SapoToolWindowBenchmarkTest {
    ...
    private static final Pattern PRECOMPILED_PATTERN = Pattern.compile(REGEX, Pattern.CASE_INSENSITIVE);
    private static final String HTML_SAMPLE = "<div>Some text here</div><span>Fixed</span>  <br> 1.2.3 and more text";
    ...
    public void benchmarkNumberFormatPerformance() throws ParseException {
        ...
        System.out.printf("NumberFormat - Unoptimized (new instance): %.2f ms%n", durationUnopt / 1_000_000.0);
        System.out.printf("NumberFormat - Static instance:           %.2f ms%n", durationStatic / 1_000_000.0);
        System.out.printf("NumberFormat - ThreadLocal instance:      %.2f ms%n", durationTL / 1_000_000.0);
