...
public class VersionUtil {
    ...
    /**
     * Finds the best fixed version from a list of fixed versions, given the current version.
     * The best fixed version is the smallest version that is strictly greater than the current version
     * and ideally in the same major branch.
     *
     ...
     * @return a negative integer, zero, or a positive integer as v1 is less than, equal to, or greater than v2.
     */
    public static int compareVersions(String v1, String v2) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (isNumeric(part1) && isNumeric(part2)) {
                comp = Integer.compare(Integer.parseInt(part1), Integer.parseInt(part2));
            } else {
