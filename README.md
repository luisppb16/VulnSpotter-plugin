...
**VulnSpotter** is a smart vulnerability scanner for your project dependencies, integrated directly into IntelliJ IDEA. It leverages
the [OSV.dev](https://osv.dev) database to provide real-time alerts and detailed remediation advice without leaving your workflow.
...
* Data is not sent: project source code.
